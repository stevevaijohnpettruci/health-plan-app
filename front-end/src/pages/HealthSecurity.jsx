...
export const HealthSecurity = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Payload sesuai validator backend Joi
      const payload = {
    ...
    >
      ...
      >
        ...
        >
          ...
          <span style={{ fontSize: 13, color: '#6B7280' }}>Step 3 of 4</span>
        </div>
        ...
        <div style={{ padding: '28px 28px 24px' }}>
          <div style={{ marginBottom: 16 }}>
            ...
            <div style={{ fontSize: 13, color: '#9CA3AF', marginTop: 4 }}>
              Your medical history and health restrictions
            </div>
          </div>
          ...
          >
            <p style={{ fontSize: 12, color: '#B45309', margin: 0 }}>
              Warning: This information is very important to ensure AI
              recommendations are safe for your health condition.
            </p>
          </div>
                ...
                {medicalOptions.map((condition) => (
                  <label
                    ...
                    style={{
                      ...
                      padding: '7px 10px',
                      border: '1.5px solid',
                      borderColor: formData.medicalHistory.includes(condition)
                        ? '#F97316'
                        : '#E5E7EB',
                      borderRadius: 8,
                      background: formData.medicalHistory.includes(condition)
                        ? '#FFF7ED'
                        : '#FFFFFF',
                    }}
                  >
