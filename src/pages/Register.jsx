...
export const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(formData.email)) { setError('Invalid email address'); return }
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {/* Header orange */}
        <div style={{ background: '#F97316', padding: '32px 24px', textAlign: 'center' }}>
          <div style={{
            width: 48, height: 48,
        ...
        <div style={{ padding: '28px 28px 24px' }}>
          <div style={{ textAlign: 'center', marginBottom: 24 }}>
            <div style={{ fontSize: 20, fontWeight: 700, color: '#1A1A1A' }}>Create account</div>
            <div style={{ fontSize: 13, color: '#9CA3AF', marginTop: 4 }}>Start your health journey today</div>
          </div>
